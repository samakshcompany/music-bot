...
module.exports = {
    ...
    discord: {
        token: process.env.DISCORD_TOKEN || 'MTQyODM5MjkxOTU2NzQzNzk0NQ.GG2iAF.FpwiSYJC78lApMvIeF820pZ39597Rf-dVIsMVA',
        clientId: process.env.CLIENT_ID || '1428392919567437945',
    ...
    bot: {
        ...
        supportServer: process.env.SUPPORT_SERVER || 'https://discord.gg/kJwf4mMs8n',
